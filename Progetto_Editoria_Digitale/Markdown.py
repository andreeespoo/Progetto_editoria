...
def modify_markdown(file_path, output_path, rules):
    ...
    """
    with open(file_path, "r", encoding="utf-8") as file:#il file viene aperto
        content = file.read()
...
# Percorsi ai file
input_file = "Relazione.md"   # File Markdown di input
output_file = "Relazione_Completata.md" # File Markdown modificato
